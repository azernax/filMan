...
CREATE TABLE `sprzedaz` (
  `sprzedaz_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `sprzedaz_id_UNIQUE` (`sprzedaz_id`)
...
INSERT INTO `sprzedaz` VALUES (1,'Ring','Mariusz','Kowaslki',4,10),(2,'Ring2','Marcin','Waluś',5,40);
